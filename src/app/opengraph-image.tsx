...
const NODES: [number, number, number, boolean][] = [
  [820, 150, 10, false], [940, 110, 7, false], [1050, 190, 9, false], [880, 260, 16, true],
  [1010, 300, 8, false], [760, 300, 7, false], [930, 390, 9, false], [1080, 400, 7, false],
  [820, 440, 8, false], [990, 480, 14, true], [720, 200, 6, false], [1120, 280, 6, false],
];
const EDGES: [number, number][] = [
  [0, 1], [1, 2], [0, 3], [3, 4], [2, 4], [3, 5], [3, 6], [4, 7], [6, 8], [6, 9], [9, 7], [5, 10], [0, 10], [2, 11], [7, 11], [8, 9],
];
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: 72, width: 720 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, fontSize: 22, color: "#a6accb", letterSpacing: 2 }}>
