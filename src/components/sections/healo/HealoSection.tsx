 ...
 * Scroll progress walks through five chapters; the active chapter lights its
...
export default function HealoSection() {
  ...
  return (
    <section
      ref={root}
      id="healo"
      aria-labelledby="healo-title"
      className="relative z-10 border-t border-line/60 bg-base"
    >
      {/* ── Intro ──────────────────────────────────────────────────────── */}
